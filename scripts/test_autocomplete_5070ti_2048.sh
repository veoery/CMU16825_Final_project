#!/bin/bash
# Ultra-conservative test for 5070 Ti - seq_len=2048
# Run this in WSL with conda environment activated: conda activate p3d_5070ti

echo "============================="
echo "Testing Autocompletion on 5070 Ti (seq_len=2048)"
echo "============================="
...
BATCH_SIZE=1
GRAD_ACCUM=32
MAX_SEQ_LEN=2048  # Very conservative
